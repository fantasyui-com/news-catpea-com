...
const database = [
...

  {
...

    {
      ...
      html: [
        `Yay, Night Mode seems to have worked out, I even gave it nice and tidy animation. [Octicons] had a light bulb icon for me so it all went smoothly. Give it a try, go to the [Research] page, put on some shades, and click on the ${octicons('light-bulb')} icon &uarr;.`,
        ``,
...

    {
      ...
      html: `Ew, lots of little  <div class="shake shake-force">${octicons('bug')}</div> fixes. I made some instrument upgrades and a few code <div class="shake shake-force">${octicons('bug')}</div><div class="shake shake-slow shake-force">${octicons('bug')}</div><div class="shake shake-force">${octicons('bug')}</div> snuck in.`,

    },

    {
      date: '2020-03-31T23:43:12.938Z',
      html: `Added [Inner City, Good Life] preset to the Beat Sequencer to test support for multiple instruments. I also added Salamander Piano, which is based on [Yamaha C5 Grand Piano], a real Piano, it sounds nice ${octicons('megaphone')}. Go to Shebang Slash Beat Sequencer, check some of those boxes to make the piano go. I set it as the default instrument.
    ...
    },
    {
      ...
      html: 'Added Squirrel <div class="shake shake-force">' + octicons('squirrel') + '</div>'
    },
    {
    ...
    },
    {
      ...
      html: 'Made the little news squirrels shake when a user pokes at them. <div class="shake shake-force pull-right">' + octicons('squirrel') + '</div>'
    },
    {
    ...
    },
    {
      ...
      html: 'Testing <a href="https://octicons.github.com/" rel="noopener noreferrer" target="_blank">octicons</a>. I love the <span class="shake">' + octicons('squirrel') + '</span> icon.'
    }
