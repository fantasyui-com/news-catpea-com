...
<main role="main">
  <section>
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-12 offset-md-2 col-md-8 offset-lg-3 col-lg-6 offset-xxl-3 col-xxl-6">
        <span class="text-warning small">Showing posts tagged {tag}</span> &middot <a class="small" href="/">show all posts</a> &middot <a class="small" href="/tags">list all tags</a>
        </div>
      </div>
      ...
      <div class="col-12 offset-md-2 col-md-8 offset-lg-3 col-lg-6 offset-xxl-3 col-xxl-6">
          ...
          <div class="mb-5">
            <h1 class="lead"><a href="/tags/{tag}/read/{item.id}" class="text-muted">{item.title}</a></h1>
            <small class="ml-3">
              &mdash;
